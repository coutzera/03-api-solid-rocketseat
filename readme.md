...
Aplicativo inspirado no modelo GymPass, com foco em gestão de academias, check-ins e autenticação de usuários.
...
- [x] 🗄️ Os dados da aplicação precisam estar persistidos em um banco PostgreSQL;
